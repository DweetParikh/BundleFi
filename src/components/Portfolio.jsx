...
import { TrendingUp, TrendingDown, Wallet, PlusCircle, BarChart2 } from 'lucide-react'
      ...
      {!hasPositions ? (
        ...
        <>
            ...
            {[
              ...
              <div key={s.label} style={{
                ...
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                  <div>
                    <div style={{ fontSize:11, color:'var(--text-3)', fontFamily:'var(--font-mono)', marginBottom:8, letterSpacing:'0.07em' }}>
                      {s.label.toUpperCase()}
                    </div>
                    <div style={{ fontFamily:'var(--font-mono)', fontWeight:600, fontSize:24, color:s.color }}>
                      {s.value}
                    </div>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:16 }}>
            {portfolio.map((pos, i) => (
              <PositionCard key={pos.bundleId} pos={pos} index={i} />
            ))}
          </div>
        </>
      )}
      ...
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', flexWrap:'wrap', gap:16 }}>
        ...
        <div style={{
          ...
          {[
            ...
            { label:'VALUE',     value:`$${pos.currentValue.toFixed(2)}`,  color:'var(--cyan)' },
            ...
            <div key={s.label} style={{ textAlign:'center' }}>
              ...
              <div style={{ fontSize:13, fontWeight:600, color:s.color, whiteSpace:'pre-line', lineHeight:1.4 }}>
                {s.value}
              </div>
            </div>
          ))}
...
function EmptyState() {
  return (
    <div style={{
      ...
      <p style={{ color:'var(--text-2)', maxWidth:400, lineHeight:1.7 }}>
        Explore curated bundles or create your own to start building your crypto portfolio.
      </p>
      <div style={{ display:'flex', gap:12, marginTop:8 }}>
        <Link to="/" style={{
          ...
          color:'var(--cyan)', fontFamily:'var(--font-display)', fontWeight:700, fontSize:14,
        ...
        <Link to="/create" style={{
          ...
          color:'var(--text-2)', fontFamily:'var(--font-display)', fontWeight:700, fontSize:14,
          display:'flex', alignItems:'center', gap:8,
        }}>
